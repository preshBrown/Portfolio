...
const Bottom = () => {
    const links = [
        ...
        {    
            ...
            child: (
                <>
                     <FaGithub style={{backgroundColor : "transparent", color: "white"}} size={33} />
                </>
            ),
        ...
        },
        {
            ...
            child: (
                <>
                     <FaTwitter style={{backgroundColor : "transparent", color: "rgb(29, 161, 242)"}} size={33} />
                </>
            ),
            href: ""
        },
        {
            ...
            child: (
                <>
                     <HiOutlineMail style={{backgroundColor : "transparent", color: "red"}} size={33} />
                </>
            ),
        ...
        },
        {
            ...
            child: (
                <>
                     <FaFacebook style={{backgroundColor : "transparent", color: "rgb(66, 103, 178)"}} size={33} />
                </>
            ),
        ...
        },
        {
            ...
            child: (
                <>
                     <BsFillPersonLinesFill style={{ color: "white"}}  size={33} />
                </>
            ),
            href: "/resume.pdf",
            style: "text-white",
